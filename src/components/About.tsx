...
const About = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row justify-center items-center md:items-end space-y-5 md:space-x-10 md:space-y-0 xl:overflow-hidden mt-[2.5in] xl:mt-0">
